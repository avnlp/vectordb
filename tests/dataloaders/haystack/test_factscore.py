"""Tests for Haystack FactScore dataset loader.

This module tests the Haystack-specific FactScoreDataloader implementation
which loads the FactScore dataset with Haystack components.
"""
...
class TestHaystackFactScoreDataloaderInitialization:
    """Test suite for Haystack FactScoreDataloader initialization.
    ...
    def test_factscore_dataloader_init_defaults(
        self, mock_openai_chat_generator
    ) -> None:
        """Test FactScore dataloader with default parameters."""
        with patch("vectordb.dataloaders.haystack.factscore.load_dataset") as mock_load:
    ...
    def test_factscore_dataloader_init_custom_split(
        self, mock_openai_chat_generator
    ) -> None:
    ...
    def test_factscore_dataloader_init_custom_dataset_name(
        self, mock_openai_chat_generator
    ) -> None:
...
class TestHaystackFactScoreDataloaderLoadData:
    """Test suite for Haystack FactScore dataset loading.
    ...
    def test_factscore_load_data_returns_list(
        self,
        haystack_factscore_sample_rows,
        ...
        with patch("vectordb.dataloaders.haystack.factscore.load_dataset") as mock_load:
            ...
            mock_dataset.__iter__ = MagicMock(
                return_value=iter(haystack_factscore_sample_rows)
            )
            mock_load.return_value = mock_dataset
    ...
    def test_factscore_load_data_correct_structure(
        ...
        with patch("vectordb.dataloaders.haystack.factscore.load_dataset") as mock_load:
            mock_dataset = MagicMock()
            mock_dataset.__iter__ = MagicMock(
                return_value=iter(haystack_factscore_sample_rows[:1])
            )
            mock_load.return_value = mock_dataset
    ...
    def test_factscore_load_data_preserves_question(
        self,
        haystack_factscore_sample_rows,
        mock_recursive_document_splitter,
        mock_openai_chat_generator,
        ...
        with patch("vectordb.dataloaders.haystack.factscore.load_dataset") as mock_load:
            ...
            assert "Tell me about Albert Einstein" in metadata["question"]

    def test_factscore_load_data_preserves_answers_and_summarized_answer(
        self,
        haystack_factscore_sample_rows,
        mock_recursive_document_splitter,
        mock_openai_chat_generator,
    ...
    def test_factscore_load_data_preserves_context_metadata(
        self,
        haystack_factscore_sample_rows,
        mock_recursive_document_splitter,
        mock_openai_chat_generator,
    ...
    def test_factscore_load_data_handles_multiple_rows(
        self,
        haystack_factscore_sample_rows,
        mock_recursive_document_splitter,
        mock_openai_chat_generator,
        ...
        with patch("vectordb.dataloaders.haystack.factscore.load_dataset") as mock_load:
            ...
            assert len(result) >= len(haystack_factscore_sample_rows)


class TestHaystackFactScoreDataloaderGetDocuments:
    ...
    def test_factscore_get_documents_returns_haystack_docs(
        self,
        haystack_factscore_sample_rows,
        mock_recursive_document_splitter,
        mock_openai_chat_generator,
...
class TestHaystackFactScoreDataloaderIntegration:
