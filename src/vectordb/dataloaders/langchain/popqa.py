"""PopQA dataloader for LangChain framework.

This module provides a LangChain-specific dataloader for the PopQA dataset,
which contains entity-centric factoid questions. The dataloader uses a
ChatGroq LLM to summarize multiple answer aliases into a canonical answer.
...
Processing Pipeline:
    ...
    2. For each question:
       ...
       c. Extract entity metadata (subject, property, object)
...
class PopQADataloader:
    """Dataloader for PopQA dataset with LangChain integration.
    ...
    def load_data(self) -> list[dict[str, Any]]:
        ...
        3. Extracting entity metadata (subject, property, object)
